...
public class LocalPerformanceAnnotationEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new serviceComposition.diagram.edit.policies.LocalPerformanceAnnotationItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof serviceComposition.diagram.edit.parts.LocalPerformanceAnnotationConcurrentUsersEditPart) {
			((serviceComposition.diagram.edit.parts.LocalPerformanceAnnotationConcurrentUsersEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureLocalPerformanceAnnotationLabelFigure());
			return true;
		}
		if (childEditPart instanceof serviceComposition.diagram.edit.parts.LocalPerformanceAnnotationConcurrentUsers2EditPart) {
			((serviceComposition.diagram.edit.parts.LocalPerformanceAnnotationConcurrentUsers2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePerformanceAnnotationConcurrentUsersLabelFigure());
			return true;
		}
		if (childEditPart instanceof serviceComposition.diagram.edit.parts.LocalPerformanceAnnotationSecsTimeLimitEditPart) {
			((serviceComposition.diagram.edit.parts.LocalPerformanceAnnotationSecsTimeLimitEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePerformanceAnnotationSecsTimeLimitLabelFigure());
			return true;
		}
		if (childEditPart instanceof serviceComposition.diagram.edit.parts.LocalPerformanceAnnotationMinimumTimeEditPart) {
			((serviceComposition.diagram.edit.parts.LocalPerformanceAnnotationMinimumTimeEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureLocalPerformanceAnnotationMinimumTimeLabelFigure());
			return true;
		}
		if (childEditPart instanceof serviceComposition.diagram.edit.parts.LocalPerformanceAnnotationWeightEditPart) {
			((serviceComposition.diagram.edit.parts.LocalPerformanceAnnotationWeightEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureLocalPerformanceAnnotationWeightLabelFigure());
			return true;
		}
		if (childEditPart instanceof serviceComposition.diagram.edit.parts.LocalPerformanceAnnotationRepsEditPart) {
			((serviceComposition.diagram.edit.parts.LocalPerformanceAnnotationRepsEditPart) childEditPart)
