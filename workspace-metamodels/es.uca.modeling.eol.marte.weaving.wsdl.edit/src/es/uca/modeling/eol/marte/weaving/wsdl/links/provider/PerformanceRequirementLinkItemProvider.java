...
/**
 * This is the item provider adapter for a {@link es.uca.modeling.eol.marte.weaving.wsdl.links.PerformanceRequirementLink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
  ...
  protected void addOperationPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_PerformanceRequirementLink_operation_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_PerformanceRequirementLink_operation_feature", "_UI_PerformanceRequirementLink_type"),
         LinksPackage.Literals.PERFORMANCE_REQUIREMENT_LINK__OPERATION,
         true,
         false,
         true,
         null,
