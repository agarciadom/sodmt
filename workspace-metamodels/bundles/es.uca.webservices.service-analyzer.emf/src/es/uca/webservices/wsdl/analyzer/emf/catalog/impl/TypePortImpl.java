 ...
 *   <li>{@link es.uca.webservices.wsdl.analyzer.emf.catalog.impl.TypePortImpl#getAddress <em>Address</em>}</li>
   ...
   */
	...
	public void setAddress(String newAddress) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MessageCatalogPackage.TYPE_PORT__ADDRESS, oldAddress, address));
	}
