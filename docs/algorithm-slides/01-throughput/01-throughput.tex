...
\begin{frame}{Running example: travel search engine}
  \begin{center}
    \input{running-example.tikz}
  \end{center}
\end{frame}

\begin{frame}{Throughput inference}
  \begin{overprint}
    \onslide<1> We add a global requirement and
    ...
    \onslide<5> Merges bring together requests from different branches: we're done!
  \end{overprint}
  \begin{center}
    \input{throughput.tikz}
  \end{center}
\end{frame}
