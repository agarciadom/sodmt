 ...
 * @generated
 */
public class PerformanceAnnotationSecsTimeLimitEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PerformanceAnnotationSecsTimeLimitEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = serviceComposition.diagram.providers.ServiceCompositionParserProvider.getParser(
					...
					getParserElement(), serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.PerformanceAnnotationSecsTimeLimitEditPart.VISUAL_ID));
		}
		return parser;
	}
