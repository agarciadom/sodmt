 ...
 * @generated
 */
public class ServiceProcessShortcutsDecoratorProvider extends AbstractProvider
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		public void refresh() {
			...
			EditPart editPart = (EditPart) getDecoratorTarget().getAdapter(
					EditPart.class);
			Image image = serviceProcess.diagram.part.ServiceProcessDiagramEditorPlugin
