...
public class ObjectNodeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new serviceProcess.diagram.edit.policies.ObjectNodeItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof serviceProcess.diagram.edit.parts.ObjectNodeNameEditPart) {
			((serviceProcess.diagram.edit.parts.ObjectNodeNameEditPart) childEditPart)
