 ...
 * @generated
 */
public class ActivityObjectNodeEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ActivityObjectNodeEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new serviceComposition.diagram.edit.policies.ActivityObjectNodeItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new ActivityObjectNodeFigure();
	}

	/**
	 * @generated
	 */
	public ActivityObjectNodeFigure getPrimaryShape() {
		return (ActivityObjectNodeFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof serviceComposition.diagram.edit.parts.ActivityObjectNodeNameEditPart) {
			((serviceComposition.diagram.edit.parts.ActivityObjectNodeNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureActivityObjectNodeLabelFigure());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class ActivityObjectNodeFigure extends RectangleFigure {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureActivityObjectNodeLabelFigure;

		/**
		 * @generated
		 */
		public ActivityObjectNodeFigure() {
		...
		private void createContents() {
			...
			fFigureActivityObjectNodeLabelFigure = new WrappingLabel();

			fFigureActivityObjectNodeLabelFigure.setText("ActivityObjectNode");

			this.add(fFigureActivityObjectNodeLabelFigure);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureActivityObjectNodeLabelFigure() {
			return fFigureActivityObjectNodeLabelFigure;
		}
