...
/**
 * This is the item provider adapter for a {@link serviceProcess.ProcessControlFlow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessControlFlowItemProvider
  extends ProcessFlowEdgeItemProvider
  implements
    ...
    IItemPropertySource
{
   ...
   * @generated
   */
  public ProcessControlFlowItemProvider(AdapterFactory adapterFactory)
  {
  ...
  /**
   * This returns ProcessControlFlow.gif.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/ProcessControlFlow"));
  }
  ...
  {
    String label = ((ProcessControlFlow)object).getCondition();
    return label == null || label.length() == 0 ?
      getString("_UI_ProcessControlFlow_type") :
      getString("_UI_ProcessControlFlow_type") + " " + label;
  }
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    switch (notification.getFeatureID(ProcessControlFlow.class))
    {
