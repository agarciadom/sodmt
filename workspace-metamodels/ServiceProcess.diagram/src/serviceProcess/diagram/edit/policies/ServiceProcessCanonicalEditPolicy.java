...
public class ServiceProcessCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize
					.add(serviceProcess.ServiceProcessPackage.eINSTANCE
							.getServiceProcess_ActivityPerformance());
			myFeaturesToSynchronize
					.add(serviceProcess.ServiceProcessPackage.eINSTANCE
	...
	private Collection<serviceProcess.diagram.part.ServiceProcessLinkDescriptor> collectAllLinks(
		...
		case serviceProcess.diagram.edit.parts.ServiceActivityEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(serviceProcess.diagram.part.ServiceProcessDiagramUpdater
						.getServiceActivity_2019ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case serviceProcess.diagram.edit.parts.ProcessStartEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(serviceProcess.diagram.part.ServiceProcessDiagramUpdater
						.getProcessStart_2020ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case serviceProcess.diagram.edit.parts.ProcessFinishEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(serviceProcess.diagram.part.ServiceProcessDiagramUpdater
						.getProcessFinish_2021ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case serviceProcess.diagram.edit.parts.ProcessDecisionEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(serviceProcess.diagram.part.ServiceProcessDiagramUpdater
						.getProcessDecision_2022ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case serviceProcess.diagram.edit.parts.ProcessForkEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(serviceProcess.diagram.part.ServiceProcessDiagramUpdater
						.getProcessFork_2023ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case serviceProcess.diagram.edit.parts.ProcessJoinEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(serviceProcess.diagram.part.ServiceProcessDiagramUpdater
						.getProcessJoin_2024ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case serviceProcess.diagram.edit.parts.ActivityPerformanceAnnotationEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(serviceProcess.diagram.part.ServiceProcessDiagramUpdater
						.getActivityPerformanceAnnotation_2017ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case serviceProcess.diagram.edit.parts.ProcessPerformanceAnnotationEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(serviceProcess.diagram.part.ServiceProcessDiagramUpdater
						.getProcessPerformanceAnnotation_2018ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case serviceProcess.diagram.edit.parts.ProcessControlFlowEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(serviceProcess.diagram.part.ServiceProcessDiagramUpdater
						.getProcessControlFlow_4005ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
