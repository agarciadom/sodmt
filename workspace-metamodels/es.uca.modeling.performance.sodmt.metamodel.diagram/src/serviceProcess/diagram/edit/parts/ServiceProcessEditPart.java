 ...
 * @generated
 */
public class ServiceProcessEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "ServiceProcess"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public ServiceProcessEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new serviceProcess.diagram.edit.policies.ServiceProcessItemSemanticEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new serviceProcess.diagram.edit.policies.ServiceProcessCanonicalEditPolicy());
		installEditPolicy(
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new serviceProcess.diagram.edit.commands.ServiceProcessCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
