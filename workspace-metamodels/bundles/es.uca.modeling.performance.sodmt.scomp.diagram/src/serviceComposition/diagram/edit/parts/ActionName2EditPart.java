 ...
 * @generated
 */
public class ActionName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActionName2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = serviceComposition.diagram.providers.ServiceCompositionParserProvider.getParser(
					serviceComposition.diagram.providers.ServiceCompositionElementTypes.Action_3001, getParserElement(),
