 ...
 * @generated
 */
public abstract class ServiceCompositionAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = serviceComposition.diagram.part.ServiceCompositionDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected ServiceCompositionAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
