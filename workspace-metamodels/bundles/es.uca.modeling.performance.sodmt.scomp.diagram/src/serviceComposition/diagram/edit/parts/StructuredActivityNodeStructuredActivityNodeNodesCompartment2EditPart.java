 ...
 * @generated
 */
public class StructuredActivityNodeStructuredActivityNodeNodesCompartment2EditPart extends ShapeCompartmentEditPart {
	 ...
	 * @generated
	 */
	public StructuredActivityNodeStructuredActivityNodeNodesCompartment2EditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return serviceComposition.diagram.part.Messages.StructuredActivityNodeStructuredActivityNodeNodesCompartment2EditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new serviceComposition.diagram.edit.policies.StructuredActivityNodeStructuredActivityNodeNodesCompartment2ItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new serviceComposition.diagram.edit.policies.StructuredActivityNodeStructuredActivityNodeNodesCompartment2CanonicalEditPolicy());
	}
