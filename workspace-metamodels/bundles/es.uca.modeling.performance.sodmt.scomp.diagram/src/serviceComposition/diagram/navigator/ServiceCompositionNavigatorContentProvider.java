 ...
 * @generated
 */
public class ServiceCompositionNavigatorContentProvider implements ICommonContentProvider {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(selectViewsByType(topViews,
					serviceComposition.diagram.edit.parts.ServiceCompositionEditPart.MODEL_ID), file, false));
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case serviceComposition.diagram.edit.parts.ServiceCompositionEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(Collections.singleton(sv),
					serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.LocalPerformanceAnnotationEditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry
		...
		case serviceComposition.diagram.edit.parts.StructuredActivityNodeEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(Collections.singleton(sv),
					serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.StructuredActivityNodeStructuredActivityNodeNodesCompartmentEditPart.VISUAL_ID));
			...
			connectedViews = getChildrenByType(connectedViews,
					serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.LocalPerformanceAnnotation2EditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.StructuredActivityNodeStructuredActivityNodeNodesCompartmentEditPart.VISUAL_ID));
		...
		case serviceComposition.diagram.edit.parts.ActivityPartitionEditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(Collections.singleton(sv),
					serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.ActivityPartitionActivityPartitionNodesCompartmentEditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry
			...
			connectedViews = getChildrenByType(connectedViews,
					serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.LocalPerformanceAnnotation3EditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(sv),
					serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.ActivityPartitionActivityPartitionNodesCompartmentEditPart.VISUAL_ID));
		...
		case serviceComposition.diagram.edit.parts.MergeNodeEditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			serviceComposition.diagram.navigator.ServiceCompositionNavigatorGroup incominglinks = new serviceComposition.diagram.navigator.ServiceCompositionNavigatorGroup(
					serviceComposition.diagram.part.Messages.NavigatorGroupName_MergeNode_2012_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			serviceComposition.diagram.navigator.ServiceCompositionNavigatorGroup outgoinglinks = new serviceComposition.diagram.navigator.ServiceCompositionNavigatorGroup(
					serviceComposition.diagram.part.Messages.NavigatorGroupName_MergeNode_2012_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry
		...
		case serviceComposition.diagram.edit.parts.StructuredActivityNode2EditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(Collections.singleton(sv),
					serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.StructuredActivityNodeStructuredActivityNodeNodesCompartment2EditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry
							.getType(serviceComposition.diagram.edit.parts.Action2EditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
		...
		case serviceComposition.diagram.edit.parts.StructuredActivityNode3EditPart.VISUAL_ID: {
			...
			connectedViews = getChildrenByType(Collections.singleton(sv),
					serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.StructuredActivityNodeStructuredActivityNodeNodesCompartment3EditPart.VISUAL_ID));
			connectedViews = getChildrenByType(connectedViews,
					serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry
							.getType(serviceComposition.diagram.edit.parts.Action2EditPart.VISUAL_ID));
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
		...
		case serviceComposition.diagram.edit.parts.MergeNode2EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			serviceComposition.diagram.navigator.ServiceCompositionNavigatorGroup incominglinks = new serviceComposition.diagram.navigator.ServiceCompositionNavigatorGroup(
					serviceComposition.diagram.part.Messages.NavigatorGroupName_MergeNode_3019_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			serviceComposition.diagram.navigator.ServiceCompositionNavigatorGroup outgoinglinks = new serviceComposition.diagram.navigator.ServiceCompositionNavigatorGroup(
					serviceComposition.diagram.part.Messages.NavigatorGroupName_MergeNode_3019_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry
		...
		case serviceComposition.diagram.edit.parts.MergeNode3EditPart.VISUAL_ID: {
			...
			Node sv = (Node) view;
			serviceComposition.diagram.navigator.ServiceCompositionNavigatorGroup incominglinks = new serviceComposition.diagram.navigator.ServiceCompositionNavigatorGroup(
					serviceComposition.diagram.part.Messages.NavigatorGroupName_MergeNode_3020_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			serviceComposition.diagram.navigator.ServiceCompositionNavigatorGroup outgoinglinks = new serviceComposition.diagram.navigator.ServiceCompositionNavigatorGroup(
					serviceComposition.diagram.part.Messages.NavigatorGroupName_MergeNode_3020_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection<View> connectedViews;
			connectedViews = getIncomingLinksByType(Collections.singleton(sv),
					serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry
	...
	private Collection<serviceComposition.diagram.navigator.ServiceCompositionNavigatorItem> createNavigatorItems(
		...
		ArrayList<serviceComposition.diagram.navigator.ServiceCompositionNavigatorItem> result = new ArrayList<serviceComposition.diagram.navigator.ServiceCompositionNavigatorItem>(
				views.size());
		for (View nextView : views) {
			result.add(new serviceComposition.diagram.navigator.ServiceCompositionNavigatorItem(nextView, parent,
					isLeafs));
		}
		return result;
	}
