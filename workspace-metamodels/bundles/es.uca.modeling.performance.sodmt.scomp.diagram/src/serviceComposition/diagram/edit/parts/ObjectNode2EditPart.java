 ...
 * @generated
 */
public class ObjectNode2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ObjectNode2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new serviceComposition.diagram.edit.policies.ObjectNode2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof serviceComposition.diagram.edit.parts.ObjectNodeName2EditPart) {
			((serviceComposition.diagram.edit.parts.ObjectNodeName2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureObjectNodeLabelFigure());
			return true;
		}
		return false;
	}
	...
	public class ObjectNodeFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			this.add(fFigureObjectNodeLabelFigure, constraintFFigureObjectNodeLabelFigure);
