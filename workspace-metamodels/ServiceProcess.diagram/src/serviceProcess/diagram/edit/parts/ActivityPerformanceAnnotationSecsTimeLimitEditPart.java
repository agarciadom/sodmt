 ...
 * @generated
 */
public class ActivityPerformanceAnnotationSecsTimeLimitEditPart extends
	 ...
	 * @generated
	 */
	public ActivityPerformanceAnnotationSecsTimeLimitEditPart(View view) {
		super(view);
	}
			...
			parser = serviceProcess.diagram.providers.ServiceProcessParserProvider
					.getParser(
							...
							serviceProcess.diagram.part.ServiceProcessVisualIDRegistry
									.getType(serviceProcess.diagram.edit.parts.ActivityPerformanceAnnotationSecsTimeLimitEditPart.VISUAL_ID));
		}
		return parser;
	}
