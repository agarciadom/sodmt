...
/**
 * This is the item provider adapter for a {@link es.uca.webservices.wsdl.analyzer.emf.catalog.TypeVariable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_TypeVariable_name_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_TypeVariable_name_feature", "_UI_TypeVariable_type"),
         MessageCatalogPackage.Literals.TYPE_VARIABLE__NAME,
         true,
         false,
         false,
  ...
  protected void addTypePropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_TypeVariable_type_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_TypeVariable_type_feature", "_UI_TypeVariable_type"),
         MessageCatalogPackage.Literals.TYPE_VARIABLE__TYPE,
         true,
         false,
         false,
         ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
