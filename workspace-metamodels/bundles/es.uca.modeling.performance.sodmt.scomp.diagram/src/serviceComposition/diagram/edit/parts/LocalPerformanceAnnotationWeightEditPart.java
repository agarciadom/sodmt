 ...
 * @generated
 */
public class LocalPerformanceAnnotationWeightEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LocalPerformanceAnnotationWeightEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = serviceComposition.diagram.providers.ServiceCompositionParserProvider.getParser(
					...
					getParserElement(), serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.LocalPerformanceAnnotationWeightEditPart.VISUAL_ID));
		}
		return parser;
	}
