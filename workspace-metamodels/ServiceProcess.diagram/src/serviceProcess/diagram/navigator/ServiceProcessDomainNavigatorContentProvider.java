 ...
 * @generated
 */
public class ServiceProcessDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public ServiceProcessDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof serviceProcess.diagram.navigator.ServiceProcessDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((serviceProcess.diagram.navigator.ServiceProcessDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new serviceProcess.diagram.navigator.ServiceProcessDomainNavigatorItem(
