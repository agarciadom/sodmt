...
public class LocalPerformanceAnnotation2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new serviceProcess.diagram.edit.policies.LocalPerformanceAnnotation2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof serviceProcess.diagram.edit.parts.LocalPerformanceAnnotationConcurrentUsers3EditPart) {
			((serviceProcess.diagram.edit.parts.LocalPerformanceAnnotationConcurrentUsers3EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureLocalPerformanceAnnotationLabelFigure());
			return true;
		}
		if (childEditPart instanceof serviceProcess.diagram.edit.parts.LocalPerformanceAnnotationConcurrentUsers4EditPart) {
			((serviceProcess.diagram.edit.parts.LocalPerformanceAnnotationConcurrentUsers4EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigurePerformanceAnnotationConcurrentUsersLabelFigure());
			return true;
		}
		if (childEditPart instanceof serviceProcess.diagram.edit.parts.LocalPerformanceAnnotationSecsTimeLimit2EditPart) {
			((serviceProcess.diagram.edit.parts.LocalPerformanceAnnotationSecsTimeLimit2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigurePerformanceAnnotationSecsTimeLimitLabelFigure());
			return true;
		}
		if (childEditPart instanceof serviceProcess.diagram.edit.parts.LocalPerformanceAnnotationMinimumTime2EditPart) {
			((serviceProcess.diagram.edit.parts.LocalPerformanceAnnotationMinimumTime2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
		...
		if (childEditPart instanceof serviceProcess.diagram.edit.parts.LocalPerformanceAnnotationWeight2EditPart) {
			((serviceProcess.diagram.edit.parts.LocalPerformanceAnnotationWeight2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
