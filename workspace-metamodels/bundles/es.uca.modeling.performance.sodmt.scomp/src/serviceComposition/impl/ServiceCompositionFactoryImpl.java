...
public class ServiceCompositionFactoryImpl extends EFactoryImpl implements ServiceCompositionFactory
{
  ...
  {
		try {
			ServiceCompositionFactory theServiceCompositionFactory = (ServiceCompositionFactory)EPackage.Registry.INSTANCE.getEFactory(ServiceCompositionPackage.eNS_URI);
