 ...
 * @generated
 */
public class PerformanceAnnotationConcurrentUsers2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PerformanceAnnotationConcurrentUsers2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = serviceComposition.diagram.providers.ServiceCompositionParserProvider.getParser(
					...
					getParserElement(), serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.PerformanceAnnotationConcurrentUsers2EditPart.VISUAL_ID));
		}
		return parser;
	}
