 ...
 * @generated
 */
public class ServiceCompositionMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = serviceComposition.diagram.part.ServiceCompositionDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			serviceComposition.diagram.part.ServiceCompositionDiagramEditorUtil.selectElementsInDiagram(editor,
