...
import es.uca.modeling.figures.DiamondFigure;

/**
 * @generated
 */
public class CompositionDecisionEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public CompositionDecisionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new serviceComposition.diagram.edit.policies.CompositionDecisionItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new CompositionDecisionFigure();
	}

	/**
	 * @generated
	 */
	public CompositionDecisionFigure getPrimaryShape() {
		return (CompositionDecisionFigure) primaryShape;
	}
	 ...
	 * @generated
	 */
	public class CompositionDecisionFigure extends DiamondFigure {

		/**
		 * @generated
		 */
		public CompositionDecisionFigure() {
