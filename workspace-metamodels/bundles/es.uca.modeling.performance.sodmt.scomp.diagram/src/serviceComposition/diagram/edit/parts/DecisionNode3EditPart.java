 ...
 * @generated
 */
public class DecisionNode3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DecisionNode3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new serviceComposition.diagram.edit.policies.DecisionNode3ItemSemanticEditPolicy());
	...
	public class DecisionNodeFigure extends ScalablePolygonShape {
		...
		public DecisionNodeFigure() {
			this.addPoint(new Point(getMapMode().DPtoLP(0), getMapMode().DPtoLP(15)));
			this.addPoint(new Point(getMapMode().DPtoLP(15), getMapMode().DPtoLP(30)));
			this.addPoint(new Point(getMapMode().DPtoLP(30), getMapMode().DPtoLP(15)));
