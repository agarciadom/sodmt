...
/**
 * This is the item provider adapter for a {@link serviceComposition.ActivityFlowNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityFlowNodeItemProvider
    ...
    IItemPropertySource
{
   ...
   * @generated
   */
  public ActivityFlowNodeItemProvider(AdapterFactory adapterFactory)
  {
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ServiceCompositionPackage.Literals.FLOW_NODE__INCOMING,
         true,
         false,
         true,
         null,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ServiceCompositionPackage.Literals.FLOW_NODE__OUTGOING,
         true,
         false,
         true,
         null,
  ...
  {
    return getString("_UI_ActivityFlowNode_type");
  }
