...
public class StructuredActivityNode3EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new serviceComposition.diagram.edit.policies.StructuredActivityNode3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE,
				new serviceComposition.diagram.edit.policies.StructuredActivityNode3GraphicalNodeEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof serviceComposition.diagram.edit.parts.StructuredActivityNodeName3EditPart) {
			((serviceComposition.diagram.edit.parts.StructuredActivityNodeName3EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureStructuredActivityNodeLabelFigure());
			return true;
		}
		if (childEditPart instanceof serviceComposition.diagram.edit.parts.StructuredActivityNodeStructuredActivityNodeNodesCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getStructuredActivityNodeNodesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(
					((serviceComposition.diagram.edit.parts.StructuredActivityNodeStructuredActivityNodeNodesCompartment3EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
