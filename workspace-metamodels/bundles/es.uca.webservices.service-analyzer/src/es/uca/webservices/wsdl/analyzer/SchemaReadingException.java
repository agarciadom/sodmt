...
/**
 * This class specifies that a problem has occurred during XML Schema reading
 *
 * @author Cristina Jiménez Gavilán (cristina.jimenezgavilan@alum.uca.es)
 */
public class SchemaReadingException extends Exception {
     ...
     */
    public SchemaReadingException(Throwable cause) {
        super(cause);
    }
     ...
     */
    public SchemaReadingException(String message, Throwable cause) {
        super(message, cause);
    }
}
