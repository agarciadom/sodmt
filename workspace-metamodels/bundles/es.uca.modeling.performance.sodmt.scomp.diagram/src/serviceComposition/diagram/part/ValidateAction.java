...
public class ValidateAction extends Action {
	...
	public static void runValidation(View view) {
		try {
			if (serviceComposition.diagram.part.ServiceCompositionDiagramEditorUtil
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		serviceComposition.diagram.providers.ServiceCompositionValidationProvider
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			serviceComposition.diagram.providers.ServiceCompositionMarkerNavigationProvider
