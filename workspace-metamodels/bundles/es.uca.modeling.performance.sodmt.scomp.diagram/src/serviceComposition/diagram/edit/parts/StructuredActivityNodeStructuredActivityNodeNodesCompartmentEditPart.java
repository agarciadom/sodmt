 ...
 * @generated
 */
public class StructuredActivityNodeStructuredActivityNodeNodesCompartmentEditPart extends ShapeCompartmentEditPart {
	 ...
	 * @generated
	 */
	public StructuredActivityNodeStructuredActivityNodeNodesCompartmentEditPart(View view) {
		super(view);
	}
	...
	public String getCompartmentName() {
		return serviceComposition.diagram.part.Messages.StructuredActivityNodeStructuredActivityNodeNodesCompartmentEditPart_title;
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new serviceComposition.diagram.edit.policies.StructuredActivityNodeStructuredActivityNodeNodesCompartmentItemSemanticEditPolicy());
		...
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new serviceComposition.diagram.edit.policies.StructuredActivityNodeStructuredActivityNodeNodesCompartmentCanonicalEditPolicy());
	}
