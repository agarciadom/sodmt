 ...
 *   <li>{@link serviceComposition.LocalPerformanceAnnotation#getReps <em>Reps</em>}</li>
...
public interface LocalPerformanceAnnotation extends PerformanceAnnotation, ActivityNode
{
   ...
   * @see #setReps(double)
   * @see serviceComposition.ServiceCompositionPackage#getLocalPerformanceAnnotation_Reps()
   * @model default="1"
  ...
  /**
   * Sets the value of the '{@link serviceComposition.LocalPerformanceAnnotation#getReps <em>Reps</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
