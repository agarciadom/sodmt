...
/**
 * This is the item provider adapter for a {@link serviceProcess.ExecutableNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ExecutableNodeItemProvider
    ...
    IItemPropertySource
{
   ...
   * @generated
   */
  public ExecutableNodeItemProvider(AdapterFactory adapterFactory)
  {
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ServiceProcessPackage.Literals.NAMED_ELEMENT__NAME,
         true,
         false,
         false,
  ...
  protected void addAnnotationPropertyDescriptor(Object object)
  {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_ExecutableNode_annotation_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_ExecutableNode_annotation_feature", "_UI_ExecutableNode_type"),
         ServiceProcessPackage.Literals.EXECUTABLE_NODE__ANNOTATION,
         true,
         false,
         true,
         null,
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(ServiceProcessPackage.Literals.EXECUTABLE_NODE__SUBNODES);
    }
  ...
  {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/ExecutableNode"));
  }
  ...
  public String getText(Object object)
  {
    ...
    return label == null || label.length() == 0 ?
      getString("_UI_ExecutableNode_type") :
      getString("_UI_ExecutableNode_type") + " " + label;
  }
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    switch (notification.getFeatureID(ExecutableNode.class))
    {
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (ServiceProcessPackage.Literals.EXECUTABLE_NODE__SUBNODES,
