...
public class StructuredActivityNodeEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new serviceProcess.diagram.edit.policies.StructuredActivityNodeItemSemanticEditPolicy());
		installEditPolicy(
				EditPolicy.GRAPHICAL_NODE_ROLE,
				new serviceProcess.diagram.edit.policies.StructuredActivityNodeGraphicalNodeEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof serviceProcess.diagram.edit.parts.StructuredActivityNodeNameEditPart) {
			((serviceProcess.diagram.edit.parts.StructuredActivityNodeNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureStructuredActivityNodeLabelFigure());
			return true;
		}
		if (childEditPart instanceof serviceProcess.diagram.edit.parts.StructuredActivityNodeStructuredActivityNodeSubnodesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getStructuredActivityNodeSubnodesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((serviceProcess.diagram.edit.parts.StructuredActivityNodeStructuredActivityNodeSubnodesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof serviceProcess.diagram.edit.parts.StructuredActivityNodeStructuredActivityNodeSubnodesCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getStructuredActivityNodeSubnodesCompartmentFigure();
			pane.remove(((serviceProcess.diagram.edit.parts.StructuredActivityNodeStructuredActivityNodeSubnodesCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	public class StructuredActivityNodeFigure extends RoundedRectangle {
		 ...
		 * @generated
		 */
		private RectangleFigure fStructuredActivityNodeSubnodesCompartmentFigure;
		...
		private void createContents() {
			...
			fStructuredActivityNodeSubnodesCompartmentFigure = new RectangleFigure();

			fStructuredActivityNodeSubnodesCompartmentFigure.setOutline(false);

			this.add(fStructuredActivityNodeSubnodesCompartmentFigure);
		 ...
		 * @generated
		 */
		public RectangleFigure getStructuredActivityNodeSubnodesCompartmentFigure() {
			return fStructuredActivityNodeSubnodesCompartmentFigure;
		}
