 ...
 * @generated
 */
public class ActivityPerformanceAnnotationConcurrentUsers2EditPart extends
	 ...
	 * @generated
	 */
	public ActivityPerformanceAnnotationConcurrentUsers2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new serviceProcess.diagram.edit.parts.ServiceProcessEditPart.NodeLabelDragPolicy());
	}
			...
			parser = serviceProcess.diagram.providers.ServiceProcessParserProvider
					.getParser(
							...
							serviceProcess.diagram.part.ServiceProcessVisualIDRegistry
									.getType(serviceProcess.diagram.edit.parts.ActivityPerformanceAnnotationConcurrentUsers2EditPart.VISUAL_ID));
		}
		return parser;
	}
