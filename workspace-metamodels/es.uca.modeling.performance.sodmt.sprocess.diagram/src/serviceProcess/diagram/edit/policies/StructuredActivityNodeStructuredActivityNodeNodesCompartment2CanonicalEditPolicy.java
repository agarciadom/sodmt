...
public class StructuredActivityNodeStructuredActivityNodeNodesCompartment2CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<serviceProcess.diagram.part.ServiceProcessNodeDescriptor> childDescriptors = serviceProcess.diagram.part.ServiceProcessDiagramUpdater
				.getStructuredActivityNodeStructuredActivityNodeNodesCompartment_7005SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<serviceProcess.diagram.part.ServiceProcessNodeDescriptor> childDescriptors = serviceProcess.diagram.part.ServiceProcessDiagramUpdater
				.getStructuredActivityNodeStructuredActivityNodeNodesCompartment_7005SemanticChildren((View) getHost()
						.getModel());
