 ...
 * @generated
 */
public class ExecutableNodeExecutableNodeSubnodesCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<serviceProcess.diagram.part.ServiceProcessNodeDescriptor> childDescriptors = serviceProcess.diagram.part.ServiceProcessDiagramUpdater
				.getExecutableNodeExecutableNodeSubnodesCompartment_7001SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<serviceProcess.diagram.part.ServiceProcessNodeDescriptor> childDescriptors = serviceProcess.diagram.part.ServiceProcessDiagramUpdater
				.getExecutableNodeExecutableNodeSubnodesCompartment_7001SemanticChildren((View) getHost()
						.getModel());
