...
public class StructuredActivityNode2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new serviceComposition.diagram.edit.policies.StructuredActivityNode2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE,
				new serviceComposition.diagram.edit.policies.StructuredActivityNode2GraphicalNodeEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof serviceComposition.diagram.edit.parts.StructuredActivityNodeName2EditPart) {
			((serviceComposition.diagram.edit.parts.StructuredActivityNodeName2EditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureStructuredActivityNodeLabelFigure());
			return true;
		}
		if (childEditPart instanceof serviceComposition.diagram.edit.parts.StructuredActivityNodeStructuredActivityNodeNodesCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getStructuredActivityNodeNodesCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(
					((serviceComposition.diagram.edit.parts.StructuredActivityNodeStructuredActivityNodeNodesCompartment2EditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof serviceComposition.diagram.edit.parts.StructuredActivityNodeStructuredActivityNodeNodesCompartment2EditPart) {
			return getPrimaryShape().getStructuredActivityNodeNodesCompartmentFigure();
		}
	...
	public class StructuredActivityNodeFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureStructuredActivityNodeLabelFigure.setText("StructuredActivityNode");
