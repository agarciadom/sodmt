 ...
 * @generated
 */
public class LocalPerformanceAnnotationConcurrentUsers4EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public LocalPerformanceAnnotationConcurrentUsers4EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = serviceComposition.diagram.providers.ServiceCompositionParserProvider.getParser(
					...
					getParserElement(), serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.LocalPerformanceAnnotationConcurrentUsers4EditPart.VISUAL_ID));
		}
		return parser;
	}
