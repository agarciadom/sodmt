 ...
 * @generated
 */
public class ProcessControlFlowConditionProbabilityEditPart extends
	 ...
	 * @generated
	 */
	public ProcessControlFlowConditionProbabilityEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new serviceProcess.diagram.edit.policies.ServiceProcessTextSelectionEditPolicy());
		installEditPolicy(
				EditPolicy.PRIMARY_DRAG_ROLE,
				new serviceProcess.diagram.edit.parts.ServiceProcessEditPart.LinkLabelDragPolicy());
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(
					this,
					null,
					serviceProcess.diagram.edit.parts.ServiceProcessEditPartFactory
	...
	protected IFigure createFigurePrim() {
		return new ProcessControlFlowLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ProcessControlFlowLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ProcessControlFlowLabelFigure() {
			this.setText("");
		}
