 ...
 * @generated
 */
public class ServiceCompositionElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public ServiceCompositionElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						serviceComposition.diagram.part.Messages.ServiceCompositionElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "serviceComposition".equals(fileExtension); //$NON-NLS-1$
	}
