...
<perf:ServiceProcess xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:perf="www.uca.es/modeling/performance/sodmt">
  ...
  <nodes xsi:type="perf:Action" incoming="//@edges.5" outgoing="//@edges.6" name="Close Order" annotation="//@nodes.8"/>
  <nodes xsi:type="perf:FinalNode" incoming="//@edges.6"/>
  <nodes xsi:type="perf:DecisionNode" incoming="//@edges.1" outgoing="//@edges.2 //@edges.7"/>
  <nodes xsi:type="perf:Action" incoming="//@edges.2" outgoing="//@edges.3" name="Divide into Segments" annotation="//@nodes.10"/>
  <nodes xsi:type="perf:StructuredActivityNode" incoming="//@edges.3" outgoing="//@edges.4" name="Process Segments" annotation="//@nodes.9">
    ...
    <nodes xsi:type="perf:LocalPerformanceAnnotation" concurrentUsers="0.5" secsTimeLimit="0.0857143" execNode="//@nodes.6/@nodes.2"/>
    <nodes xsi:type="perf:LocalPerformanceAnnotation" concurrentUsers="0.5" secsTimeLimit="0.0428571" execNode="//@nodes.6/@nodes.4"/>
    <nodes xsi:type="perf:LocalPerformanceAnnotation" concurrentUsers="0.5" secsTimeLimit="0.0428571" execNode="//@nodes.6/@nodes.3"/>
  </nodes>
  <nodes xsi:type="perf:JoinNode" incoming="//@edges.4 //@edges.7" outgoing="//@edges.5"/>
  <nodes xsi:type="perf:LocalPerformanceAnnotation" secsTimeLimit="0.0857143" execNode="//@nodes.2"/>
  <nodes xsi:type="perf:LocalPerformanceAnnotation" concurrentUsers="0.5" secsTimeLimit="0.0857143" reps="5.0" execNode="//@nodes.6"/>
  <nodes xsi:type="perf:LocalPerformanceAnnotation" concurrentUsers="0.5" secsTimeLimit="0.0857143" execNode="//@nodes.5"/>
  ...
  <edges xsi:type="perf:ControlFlow" source="//@nodes.6" target="//@nodes.7"/>
  <edges xsi:type="perf:ControlFlow" source="//@nodes.7" target="//@nodes.2"/>
  <edges xsi:type="perf:ControlFlow" source="//@nodes.2" target="//@nodes.3"/>
  <edges xsi:type="perf:ControlFlow" source="//@nodes.4" target="//@nodes.7" condition="rejected" probability="0.5"/>
