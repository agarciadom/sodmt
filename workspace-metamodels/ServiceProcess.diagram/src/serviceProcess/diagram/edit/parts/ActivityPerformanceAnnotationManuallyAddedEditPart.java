 ...
 * @generated
 */
public class ActivityPerformanceAnnotationManuallyAddedEditPart extends
	 ...
	 * @generated
	 */
	public ActivityPerformanceAnnotationManuallyAddedEditPart(View view) {
		super(view);
	}
			...
			parser = serviceProcess.diagram.providers.ServiceProcessParserProvider
					.getParser(
							...
							serviceProcess.diagram.part.ServiceProcessVisualIDRegistry
									.getType(serviceProcess.diagram.edit.parts.ActivityPerformanceAnnotationManuallyAddedEditPart.VISUAL_ID));
		}
		return parser;
	}
