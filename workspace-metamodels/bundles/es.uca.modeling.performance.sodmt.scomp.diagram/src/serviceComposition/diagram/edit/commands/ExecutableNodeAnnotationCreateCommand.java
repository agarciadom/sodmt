...
public class ExecutableNodeAnnotationCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	protected serviceComposition.ExecutableNode getSource() {
		return (serviceComposition.ExecutableNode) source;
	}

	/**
	 * @generated
	 */
	protected serviceComposition.LocalPerformanceAnnotation getTarget() {
		return (serviceComposition.LocalPerformanceAnnotation) target;
	}
}
