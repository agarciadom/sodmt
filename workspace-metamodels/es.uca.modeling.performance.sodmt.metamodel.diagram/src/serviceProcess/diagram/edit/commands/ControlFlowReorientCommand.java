...
public class ControlFlowReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof serviceProcess.ControlFlow) {
			return false;
		}
	 ...
	 * @generated
	 */
	protected serviceProcess.ControlFlow getLink() {
		return (serviceProcess.ControlFlow) getElementToEdit();
	}
