 ...
 * @generated
 */
public class FinalNode2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public FinalNode2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new serviceProcess.diagram.edit.policies.FinalNode2ItemSemanticEditPolicy());
	...
	public class FinalNodeFigure extends SVGFigure {
		...
		public FinalNodeFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.performance.sodmt.metamodel/svg/flow-final.svg");
