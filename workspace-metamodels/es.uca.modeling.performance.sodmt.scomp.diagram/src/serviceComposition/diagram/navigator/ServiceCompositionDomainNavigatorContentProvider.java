 ...
 * @generated
 */
public class ServiceCompositionDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public ServiceCompositionDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof serviceComposition.diagram.navigator.ServiceCompositionDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((serviceComposition.diagram.navigator.ServiceCompositionDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new serviceComposition.diagram.navigator.ServiceCompositionDomainNavigatorItem(
