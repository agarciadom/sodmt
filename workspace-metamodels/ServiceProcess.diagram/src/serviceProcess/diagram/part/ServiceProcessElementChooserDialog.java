 ...
 * @generated
 */
public class ServiceProcessElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public ServiceProcessElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell()
				.setText(
						serviceProcess.diagram.part.Messages.ServiceProcessElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "serviceProcess".equals(fileExtension); //$NON-NLS-1$
	}
