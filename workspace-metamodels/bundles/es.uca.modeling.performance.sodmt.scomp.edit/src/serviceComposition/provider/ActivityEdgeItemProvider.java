...
/**
 * This is the item provider adapter for a {@link serviceComposition.ActivityEdge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ServiceCompositionPackage.Literals.ACTIVITY_EDGE__SOURCE,
         true,
         false,
         true,
         null,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ServiceCompositionPackage.Literals.ACTIVITY_EDGE__TARGET,
         true,
         false,
         true,
         null,
  ...
  {
    return getString("_UI_ActivityEdge_type");
  }
