 ...
 * @generated
 */
public class ObjectNode3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ObjectNode3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new serviceComposition.diagram.edit.policies.ObjectNode3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof serviceComposition.diagram.edit.parts.ObjectNodeName3EditPart) {
			((serviceComposition.diagram.edit.parts.ObjectNodeName3EditPart) childEditPart)
