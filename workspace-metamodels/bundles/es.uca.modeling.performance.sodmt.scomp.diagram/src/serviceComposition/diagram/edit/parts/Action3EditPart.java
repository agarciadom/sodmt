 ...
 * @generated
 */
public class Action3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Action3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new serviceComposition.diagram.edit.policies.Action3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE,
				new serviceComposition.diagram.edit.policies.Action3GraphicalNodeEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof serviceComposition.diagram.edit.parts.ActionName3EditPart) {
			((serviceComposition.diagram.edit.parts.ActionName3EditPart) childEditPart)
	...
	public class ActionFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			this.add(fFigureActionLabelFigure, constraintFFigureActionLabelFigure);
