 ...
 * @generated
 */
public class StructuredActivityNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
		...
		if (parser == null) {
			parser = serviceComposition.diagram.providers.ServiceCompositionParserProvider.getParser(
					...
					getParserElement(), serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.StructuredActivityNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
