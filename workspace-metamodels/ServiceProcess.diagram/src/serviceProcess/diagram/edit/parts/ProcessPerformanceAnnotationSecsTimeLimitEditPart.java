 ...
 * @generated
 */
public class ProcessPerformanceAnnotationSecsTimeLimitEditPart extends
	 ...
	 * @generated
	 */
	public ProcessPerformanceAnnotationSecsTimeLimitEditPart(View view) {
		super(view);
	}
			...
			parser = serviceProcess.diagram.providers.ServiceProcessParserProvider
					.getParser(
							...
							serviceProcess.diagram.part.ServiceProcessVisualIDRegistry
									.getType(serviceProcess.diagram.edit.parts.ProcessPerformanceAnnotationSecsTimeLimitEditPart.VISUAL_ID));
		}
		return parser;
	}
