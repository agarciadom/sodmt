...
public class StructuredActivityNodeStructuredActivityNodeNodesCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<serviceProcess.diagram.part.ServiceProcessNodeDescriptor> childDescriptors = serviceProcess.diagram.part.ServiceProcessDiagramUpdater
				.getStructuredActivityNodeStructuredActivityNodeNodesCompartment_7003SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<serviceProcess.diagram.part.ServiceProcessNodeDescriptor> childDescriptors = serviceProcess.diagram.part.ServiceProcessDiagramUpdater
				.getStructuredActivityNodeStructuredActivityNodeNodesCompartment_7003SemanticChildren((View) getHost()
						.getModel());
