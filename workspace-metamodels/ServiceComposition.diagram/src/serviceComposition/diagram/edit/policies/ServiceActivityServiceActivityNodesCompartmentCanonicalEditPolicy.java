 ...
 * @generated
 */
public class ServiceActivityServiceActivityNodesCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<serviceComposition.diagram.part.ServiceCompositionNodeDescriptor> childDescriptors = serviceComposition.diagram.part.ServiceCompositionDiagramUpdater
				.getServiceActivityServiceActivityNodesCompartment_7003SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<serviceComposition.diagram.part.ServiceCompositionNodeDescriptor> childDescriptors = serviceComposition.diagram.part.ServiceCompositionDiagramUpdater
				.getServiceActivityServiceActivityNodesCompartment_7003SemanticChildren((View) getHost()
						.getModel());
