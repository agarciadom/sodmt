...
public class ObjectFlowCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return serviceComposition.diagram.edit.policies.ServiceCompositionBaseItemSemanticEditPolicy
				.getLinkConstraints().canCreateObjectFlow_4002(getContainer(), getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		serviceComposition.ObjectFlow newElement = serviceComposition.ServiceCompositionFactory.eINSTANCE
				.createObjectFlow();
	 ...
	 * @generated
	 */
	protected void doConfigure(serviceComposition.ObjectFlow newElement, IProgressMonitor monitor, IAdaptable info)
	 ...
	 * @generated
	 */
	protected serviceComposition.ActivityNode getSource() {
		return (serviceComposition.ActivityNode) source;
	}

	/**
	 * @generated
	 */
	protected serviceComposition.ActivityNode getTarget() {
		return (serviceComposition.ActivityNode) target;
	}
