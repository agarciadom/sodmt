...
public class TypeDateTime extends AbstractDates {
    ...
    private static final int HASHM = 83;
    ...
    public boolean equals(Object o) {
        if (!(o instanceof TypeDateTime)) {
            return false;
        }
        final TypeDateTime tDateTime = (TypeDateTime) o;
        return tDateTime == this || ((tDateTime.getMaxValue().equals(this.getMaxValue()))
                && tDateTime.getMinValue().equals(this.getMinValue()));
    }
