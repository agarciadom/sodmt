 ...
 * @generated
 */
public class StructuredActivityNodeName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
		...
		if (parser == null) {
			parser = serviceComposition.diagram.providers.ServiceCompositionParserProvider.getParser(
					...
					getParserElement(), serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.StructuredActivityNodeName3EditPart.VISUAL_ID));
		}
		return parser;
	}
