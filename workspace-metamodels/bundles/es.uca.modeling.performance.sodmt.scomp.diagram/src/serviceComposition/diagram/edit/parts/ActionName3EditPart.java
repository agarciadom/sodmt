 ...
 * @generated
 */
public class ActionName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ActionName3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = serviceComposition.diagram.providers.ServiceCompositionParserProvider.getParser(
					serviceComposition.diagram.providers.ServiceCompositionElementTypes.Action_3010, getParserElement(),
