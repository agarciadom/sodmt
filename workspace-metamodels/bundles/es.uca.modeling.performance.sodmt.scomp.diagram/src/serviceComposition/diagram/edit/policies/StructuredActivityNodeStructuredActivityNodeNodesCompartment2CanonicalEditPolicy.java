 ...
 * @generated
 */
public class StructuredActivityNodeStructuredActivityNodeNodesCompartment2CanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return serviceComposition.ServiceCompositionPackage.eINSTANCE.getStructuredActivityNode_Nodes();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<serviceComposition.diagram.part.ServiceCompositionNodeDescriptor> childDescriptors = serviceComposition.diagram.part.ServiceCompositionDiagramUpdater
				.getStructuredActivityNodeStructuredActivityNodeNodesCompartment_7002SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<serviceComposition.diagram.part.ServiceCompositionNodeDescriptor> childDescriptors = serviceComposition.diagram.part.ServiceCompositionDiagramUpdater
				.getStructuredActivityNodeStructuredActivityNodeNodesCompartment_7002SemanticChildren(
