 ...
 * @generated
 */
public class ActivityPerformanceAnnotationWeightEditPart extends
	 ...
	 * @generated
	 */
	public ActivityPerformanceAnnotationWeightEditPart(View view) {
		super(view);
	}
			...
			parser = serviceProcess.diagram.providers.ServiceProcessParserProvider
					.getParser(
							...
							serviceProcess.diagram.part.ServiceProcessVisualIDRegistry
									.getType(serviceProcess.diagram.edit.parts.ActivityPerformanceAnnotationWeightEditPart.VISUAL_ID));
		}
		return parser;
	}
