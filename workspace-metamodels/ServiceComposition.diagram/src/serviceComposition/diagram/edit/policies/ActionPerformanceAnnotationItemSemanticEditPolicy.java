 ...
 * @generated
 */
public class ActionPerformanceAnnotationItemSemanticEditPolicy
		extends
	 ...
	 * @generated
	 */
	public ActionPerformanceAnnotationItemSemanticEditPolicy() {
		super(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (serviceComposition.diagram.providers.ServiceCompositionElementTypes.ActivityActionAnnotation_4008 == req
				.getElementType()) {
			return null;
		}
		return null;
	...
	protected Command getCompleteCreateRelationshipCommand(
		...
		if (serviceComposition.diagram.providers.ServiceCompositionElementTypes.ActivityActionAnnotation_4008 == req
				.getElementType()) {
			return getGEFWrapper(new serviceComposition.diagram.edit.commands.ActivityActionAnnotationCreateCommand(
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case serviceComposition.diagram.edit.parts.ActivityActionAnnotationEditPart.VISUAL_ID:
			return getGEFWrapper(new serviceComposition.diagram.edit.commands.ActivityActionAnnotationReorientCommand(
					req));
		}
