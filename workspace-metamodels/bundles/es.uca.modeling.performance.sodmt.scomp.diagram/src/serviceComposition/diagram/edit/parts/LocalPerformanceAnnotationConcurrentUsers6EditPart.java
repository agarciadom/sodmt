 ...
 * @generated
 */
public class LocalPerformanceAnnotationConcurrentUsers6EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public LocalPerformanceAnnotationConcurrentUsers6EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = serviceComposition.diagram.providers.ServiceCompositionParserProvider.getParser(
					...
					getParserElement(), serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.LocalPerformanceAnnotationConcurrentUsers6EditPart.VISUAL_ID));
		}
		return parser;
	}
