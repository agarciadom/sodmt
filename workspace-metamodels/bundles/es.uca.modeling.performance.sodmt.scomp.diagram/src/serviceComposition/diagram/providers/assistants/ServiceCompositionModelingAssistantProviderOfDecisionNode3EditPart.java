 ...
 * @generated
 */
public class ServiceCompositionModelingAssistantProviderOfDecisionNode3EditPart
	...
	*/
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((serviceComposition.diagram.edit.parts.DecisionNode3EditPart) sourceEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnSource(
			serviceComposition.diagram.edit.parts.DecisionNode3EditPart source) {
	...
	*/
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget(
				(serviceComposition.diagram.edit.parts.DecisionNode3EditPart) sourceEditPart, targetEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnSourceAndTarget(
			serviceComposition.diagram.edit.parts.DecisionNode3EditPart source, IGraphicalEditPart targetEditPart) {
	...
	*/
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((serviceComposition.diagram.edit.parts.DecisionNode3EditPart) sourceEditPart,
				relationshipType);
	}
	...
	* @generated
	*/
	public List<IElementType> doGetTypesForTarget(serviceComposition.diagram.edit.parts.DecisionNode3EditPart source,
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((serviceComposition.diagram.edit.parts.DecisionNode3EditPart) targetEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnTarget(
			serviceComposition.diagram.edit.parts.DecisionNode3EditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(2);
		types.add(serviceComposition.diagram.providers.ServiceCompositionElementTypes.ControlFlow_4001);
		types.add(serviceComposition.diagram.providers.ServiceCompositionElementTypes.ObjectFlow_4002);
		return types;
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((serviceComposition.diagram.edit.parts.DecisionNode3EditPart) targetEditPart,
				relationshipType);
	}
	...
	* @generated
	*/
	public List<IElementType> doGetTypesForSource(serviceComposition.diagram.edit.parts.DecisionNode3EditPart target,
			IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == serviceComposition.diagram.providers.ServiceCompositionElementTypes.ControlFlow_4001) {
			types.add(serviceComposition.diagram.providers.ServiceCompositionElementTypes.Action_2001);
