...
public class PerformanceAnnotationEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new serviceProcess.diagram.edit.policies.PerformanceAnnotationItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof serviceProcess.diagram.edit.parts.PerformanceAnnotationConcurrentUsersEditPart) {
			((serviceProcess.diagram.edit.parts.PerformanceAnnotationConcurrentUsersEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigurePerformanceAnnotationLabelFigure());
			return true;
		}
		if (childEditPart instanceof serviceProcess.diagram.edit.parts.PerformanceAnnotationConcurrentUsers2EditPart) {
			((serviceProcess.diagram.edit.parts.PerformanceAnnotationConcurrentUsers2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigurePerformanceAnnotationConcurrentUsersLabelFigure());
			return true;
		}
		if (childEditPart instanceof serviceProcess.diagram.edit.parts.PerformanceAnnotationSecsTimeLimitEditPart) {
			((serviceProcess.diagram.edit.parts.PerformanceAnnotationSecsTimeLimitEditPart) childEditPart)
					.setLabel(getPrimaryShape()
