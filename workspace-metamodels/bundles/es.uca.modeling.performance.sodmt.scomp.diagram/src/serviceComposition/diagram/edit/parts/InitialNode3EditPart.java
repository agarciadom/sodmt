 ...
 * @generated
 */
public class InitialNode3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public InitialNode3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new serviceComposition.diagram.edit.policies.InitialNode3ItemSemanticEditPolicy());
	...
	public class InitialNodeFigure extends SVGFigure {
		...
		public InitialNodeFigure() {
			this.setURI("platform:/plugin/es.uca.modeling.performance.sodmt.sprocess/svg/initial.svg");
