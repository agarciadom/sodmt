 ...
 * @generated
 */
public class ActivityPerformanceAnnotationMinimumTimeEditPart extends
	 ...
	 * @generated
	 */
	public ActivityPerformanceAnnotationMinimumTimeEditPart(View view) {
		super(view);
	}
			...
			parser = serviceProcess.diagram.providers.ServiceProcessParserProvider
					.getParser(
							...
							serviceProcess.diagram.part.ServiceProcessVisualIDRegistry
									.getType(serviceProcess.diagram.edit.parts.ActivityPerformanceAnnotationMinimumTimeEditPart.VISUAL_ID));
		}
		return parser;
	}
