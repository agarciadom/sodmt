 ...
 * @generated
 */
public class ControlFlowConditionProbabilityEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ControlFlowConditionProbabilityEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new serviceComposition.diagram.edit.policies.ServiceCompositionTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = serviceComposition.diagram.providers.ServiceCompositionParserProvider.getParser(
					serviceComposition.diagram.providers.ServiceCompositionElementTypes.ControlFlow_4001,
					getParserElement(), serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.ControlFlowConditionProbabilityEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					serviceComposition.diagram.edit.parts.ServiceCompositionEditPartFactory
	 ...
	 * @generated
	 */
	public class ControlFlowLabelFigure extends WrappingLabel {
