...
public class ObjectNode2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new serviceProcess.diagram.edit.policies.ObjectNode2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof serviceProcess.diagram.edit.parts.ObjectNodeName2EditPart) {
			((serviceProcess.diagram.edit.parts.ObjectNodeName2EditPart) childEditPart)
