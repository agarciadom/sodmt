 ...
 * @generated
 */
public class ServiceCompositionDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof serviceComposition.diagram.navigator.ServiceCompositionDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(
					((serviceComposition.diagram.navigator.ServiceCompositionDomainNavigatorItem) parentElement)
							.getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
