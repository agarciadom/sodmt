...
public class ValidateAction extends Action {
	...
	public ValidateAction(IWorkbenchPage page) {
		setText(serviceProcess.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	public static void runValidation(View view) {
		try {
			if (serviceProcess.diagram.part.ServiceProcessDiagramEditorUtil
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		serviceProcess.diagram.providers.ServiceProcessValidationProvider
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			serviceProcess.diagram.providers.ServiceProcessMarkerNavigationProvider
	...
	private static void createMarkers(IFile target, IStatus validationStatus,
		...
		serviceProcess.diagram.part.ServiceProcessDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new serviceProcess.diagram.part.ServiceProcessDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(), collectTargetElements(
						rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = serviceProcess.diagram.part.ServiceProcessDiagramEditorUtil
