 ...
 * @generated
 */
public class ServiceCompositionEditPart extends DiagramEditPart {

	/**
	 * @generated
	 */
	public final static String MODEL_ID = "ServiceComposition"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	public ServiceCompositionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new serviceComposition.diagram.edit.policies.ServiceCompositionItemSemanticEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new serviceComposition.diagram.edit.policies.ServiceCompositionCanonicalEditPolicy());
		installEditPolicy(
						...
						if (command != null) {
							return command
									.chain(new ICommandProxy(
											new serviceComposition.diagram.edit.commands.ServiceCompositionCreateShortcutDecorationsCommand(
													getEditingDomain(),
													(View) getModel(),
													viewDescriptors)));
						}
