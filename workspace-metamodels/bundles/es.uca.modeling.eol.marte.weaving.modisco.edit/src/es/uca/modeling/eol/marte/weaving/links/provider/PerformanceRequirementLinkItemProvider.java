...
public class PerformanceRequirementLinkItemProvider 
	...
	public String getText(Object object) {
		TimeLimitMetric labelValue = ((PerformanceRequirementLink)object).getMetric();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_PerformanceRequirementLink_type") :
			getString("_UI_PerformanceRequirementLink_type") + " " + label;
	}
