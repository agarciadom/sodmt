 ...
 * @generated
 */
public class LocalPerformanceAnnotationSecsTimeLimit3EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public LocalPerformanceAnnotationSecsTimeLimit3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = serviceComposition.diagram.providers.ServiceCompositionParserProvider.getParser(
					...
					getParserElement(), serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.LocalPerformanceAnnotationSecsTimeLimit3EditPart.VISUAL_ID));
		}
		return parser;
	}
