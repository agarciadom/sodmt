 ...
 * @generated
 */
public abstract class ServiceProcessAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = serviceProcess.diagram.part.ServiceProcessDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected ServiceProcessAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
