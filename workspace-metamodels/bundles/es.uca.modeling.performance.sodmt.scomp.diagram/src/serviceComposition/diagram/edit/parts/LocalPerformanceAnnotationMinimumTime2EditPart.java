 ...
 * @generated
 */
public class LocalPerformanceAnnotationMinimumTime2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LocalPerformanceAnnotationMinimumTime2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = serviceComposition.diagram.providers.ServiceCompositionParserProvider.getParser(
					...
					getParserElement(), serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.LocalPerformanceAnnotationMinimumTime2EditPart.VISUAL_ID));
		}
		return parser;
	}
