 ...
 * @generated
 */
public class LocalPerformanceAnnotationRepsEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public LocalPerformanceAnnotationRepsEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = serviceComposition.diagram.providers.ServiceCompositionParserProvider.getParser(
					...
					getParserElement(), serviceComposition.diagram.part.ServiceCompositionVisualIDRegistry.getType(
							serviceComposition.diagram.edit.parts.LocalPerformanceAnnotationRepsEditPart.VISUAL_ID));
		}
		return parser;
	}
