  ...
  protected void createGmf_2Annotations()
  {
    ...
    addAnnotation
      (initialNodeEClass, 
       ...
       {
       "figure", "svg",
       "svg.uri", "platform:/plugin/es.uca.modeling.performance.sodmt.metamodel/svg/initial.svg",
       "size", "30,30",
    ...
    addAnnotation
      (finalNodeEClass, 
       ...
       {
       "figure", "svg",
       "svg.uri", "platform:/plugin/es.uca.modeling.performance.sodmt.metamodel/svg/flow-final.svg",
       "size", "30,30",
       "label.placement", "none",
       "resizable", "false",
       "margin", "0",
