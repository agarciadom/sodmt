...
/**
 * This is the item provider adapter for a {@link serviceProcess.PerformanceAnnotation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PerformanceAnnotationItemProvider
    ...
    IItemPropertySource
{
   ...
   * @generated
   */
  public PerformanceAnnotationItemProvider(AdapterFactory adapterFactory)
  {
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ServiceProcessPackage.Literals.PERFORMANCE_ANNOTATION__CONCURRENT_USERS,
         true,
         false,
         false,
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         ServiceProcessPackage.Literals.PERFORMANCE_ANNOTATION__SECS_TIME_LIMIT,
         true,
         false,
         false,
         ItemPropertyDescriptor.REAL_VALUE_IMAGE,
  ...
  /**
   * This returns PerformanceAnnotation.gif.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/PerformanceAnnotation"));
  }
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    switch (notification.getFeatureID(PerformanceAnnotation.class))
    {
